...
-- Restore default Data API grants on all public tables
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.quote_tokens TO authenticated;
...
GRANT SELECT ON public.company_flags TO authenticated;
