      ...
      <header className="border-b border-border">
        <div className="container flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            <Droplets className="w-6 h-6" style={{ color: `hsl(${brand.primaryHue} 70% 45%)` }} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
                Professional plumbing quotes in 60 seconds
              </h1>
              
              <p className="text-xl text-muted-foreground mb-8 max-w-lg">
                Stop losing evenings to paperwork. Create, send, and track quotes from your phone — on site, between jobs, wherever.
              </p>

              <div className="space-y-3 mb-8">
                {[
                  "Pre-loaded plumbing rates and materials",
                  "Branded PDFs your customers trust",
      ...
      <footer className="py-8 border-t border-border">
        <div className="container text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Professional quoting for UK plumbers.
          </p>
        </div>
      </footer>
    </div>
